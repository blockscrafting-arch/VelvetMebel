...
/**
 * Заголовки столбцов (должны совпадать с логикой bot/services/sheets.py)
 * A: Дата, B: Имя, C: Ник/ID, D: Модель, E: Статус, F: Примечание
 */
const HEADERS = ['Дата', 'Имя', 'Ник/ID', 'Модель', 'Статус', 'Примечание'];
